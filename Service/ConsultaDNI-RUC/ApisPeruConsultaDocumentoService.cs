...
namespace Service.ConsultaDNI_RUC
{
    public class ApisPeruConsultaDocumentoService : IApisPeruConsultaDocumentoService
    {
        ApisPeruEmpresaResponse empresaResult;
        ApisPeruPersonaResponse personaResult;
        public ApisPeruConsultaDocumentoService()
        {
